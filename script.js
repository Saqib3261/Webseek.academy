...
if (
  sessionStorage.getItem("webseek_seen")
) {
  ...
  notesBtn.addEventListener(
    ...
    () => {
      ...
      if (
        ...
        alert(
          "Your Notes PDF link will be added here."
        );
